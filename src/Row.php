...
*/
class Row extends ORMAbstract implements IteratorAggregate, ArrayAccess, Countable, JsonSerializable {
	...
	*/
	function delete() {
		...
		$result = new Result($this->result->table, $this->result->solutionORM);
